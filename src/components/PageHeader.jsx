  ...
  return (
    <div className={styles.pageHeaderContainer}>
      <div className={styles.pageHeader}>
        ...
        <div className={styles.updatedStatus}>
          <div className={styles.lastUpdatedContainer}>
            <div className={styles.leftPartOfUpdatedContainer}>
              <svg
                width="20"
                height="20"
                viewBox="0 0 20 20"
              ...
              <p className={styles.monthAndYear}> &nbsp;February 22, 2020</p>
              <svg
                width="20"
                height="20"
                viewBox="0 0 20 20"
            ...
            <div className={styles.rightPartOfUpdatedContainer}>
              <select>
        ...
        <div className={styles.buildingAssistantToolsContainer}>
          <div className={styles.buildingAssistantTools}>
            <div className={styles.tools}>
              <p>Tools</p>
            </div>
            <div className={styles.awsBuilder}>
              <p>AWS Builder</p>
            </div>
            <div className={styles.startBuild}>
              <p>Start Build</p>
            </div>
            <div className={styles.buildSupplies}>
              <p>Build Supplies</p>
            </div>
            <div className={styles.tooling}>
              <p>Tooling</p>
            </div>
            <div className="blueHosting">
              <p>Blue Hosting</p>
            </div>
          </div>
          <div className={styles.horizontalRule}></div>
